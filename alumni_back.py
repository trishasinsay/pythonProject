...
class Win:
    def __init__(self, root):
        ...
        # LABELS
        self.L1 = Label(self.F1, text='STUDENT ID NUMBER', font=F3, bg='#D8D8D8').place(x=10, y=100)
        self.L2 = Label(self.F1, text='SIGNATURE', font=F3, bg='#D8D8D8').place(x=10, y=150)
