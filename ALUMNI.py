...
class Win:
    def __init__(self, root):
        ...
        # LABELS
        self.L1 = Label(self.F1, text='STUDENT ID NUMBER', font=F3, bg='#D8D8D8').place(x=10, y=60)
        self.L2 = Label(self.F1, text='FIRST NAME & M.I.', font=F3, bg='#D8D8D8').place(x=10, y=100)
        self.L3 = Label(self.F1, text='LAST NAME', font=F3, bg='#D8D8D8').place(x=10, y=140)
        self.L4 = Label(self.F1, text='PROGRAM', font=F3, bg='#D8D8D8').place(x=10, y=180)
        self.L5 = Label(self.F1, text='YEAR GRADUATED', font=F3, bg='#D8D8D8').place(x=10, y=220)
        self.L6 = Label(self.F1, text='TIN', font=F3, bg='#D8D8D8').place(x=10, y=260)
        self.L7 = Label(self.F1, text='SSS/GSIS NO.', font=F3, bg='#D8D8D8').place(x=10, y=310)
        ...
        self.L9 = Label(self.F1,text='*Note: When you are capturing image, press the ENTER KEY to capture your image',font=F4, bg='#D8D8D8')
